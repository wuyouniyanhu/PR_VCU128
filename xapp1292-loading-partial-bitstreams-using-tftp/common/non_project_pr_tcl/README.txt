...
+ design.tcl
    ...
    - add_module              -> Defines the top-level of lower-level module to be run with bottom-up 
                                 ...
                                 obtained using set_module_attribute/get_module_attribute, respectively.

    - add_ooc_implemmentation -> Used to define an out-of-context implementation run. Various implementation
                                 attibutes (listed below) can be defined or obtained using set_ooc_attribute
                                 or get_ooc_attribute, respectively.
    ...
    - add_implementation      -> Used to define an implementation to run a design flat, to assemble an OOC 
                                 ...
                                 or obtained using set_impl_attribute or get_impl_attribute, respectively.
                                  
    - add_configuration       -> Used to define a Partial Reconfiguation implementation. Various configuration 
                                 attibutes (listed below) can be defined or obtained using set_config_attribute
                                 or get_config_attribute, respectively.
