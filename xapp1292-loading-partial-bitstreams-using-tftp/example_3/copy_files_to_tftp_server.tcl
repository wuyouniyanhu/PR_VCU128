...
set files ""
set files "Sources/tftp/rm_info.csv"

# In this example we take the partial bitstreams from the Bitstreams directory.
# These are the unprocessed bin files created by write_bitstream
#
lappend files {*}[glob -directory Bitstreams *.bin]
